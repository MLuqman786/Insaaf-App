    ...
    <>
      <div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-12  text-center pb-5 pt-5 ">

            <div className="bg-white text-2xl   overflow-hidden  rounded-lg shadow-lg font-bold transition-transform transform hover:scale-105 hover:cursor-pointer  hover:underline text-green-700 col-span-4" >
              <img src="iman-khan.webp" className="h-60 w-96 " alt="" />
              <h1 className="p-5">Creating a strong economy</h1>
            </div>

            <div className="bg-white text-2xl overflow-hidden  shadow-lg font-bold transition-transform transform hover:scale-105 hover:cursor-pointer rounded-lg hover:underline text-green-700 col-span-4">
              <img src="kids.jpg" className="h-60  " alt="" />
              <h1 className=" p-5">Fixing the cost of living </h1>
            </div>

            <div className="bg-white text-2xl rounded-lg overflow-hidden  shadow-lg font-bold transition-transform transform hover:scale-105 hover:cursor-pointer  hover:underline text-green-700 col-span-4">
